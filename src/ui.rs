...
pub fn ui<B: Backend>(f: &mut Frame<B>, app: &mut App) {
  ...
  f.render_widget(
    Block::default()
      .title(Span::styled(app.generate_pwd_str(), Style::default().fg(Color::Yellow)))
  ...
  f.render_stateful_widget(grandparent_items, chunks[0], &mut app.grandparent_items.state);
